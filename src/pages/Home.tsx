...
const phrases = {
  ...
  DINERO: [
    { text: "¿Por qué el dinero fluye fácilmente y abundantemente hacia mí?" },
    { text: "¿Por qué cada día me acerco más a mi libertad financiera?" },
    { text: "¿Por qué soy un imán para la prosperidad y la abundancia?" },
    { text: "¿Por qué tomo decisiones financieras inteligentes y seguras?" },
    { text: "¿Por qué el dinero trabaja a mi favor y me brinda estabilidad?" },
  ],
  RELACIONES: [
    { text: "¿Por qué mis relaciones son armoniosas y enriquecedoras?" },
    { text: "¿Por qué atraigo personas que me valoran y respetan?" },
    { text: "¿Por qué mis conexiones personales son profundas y significativas?" },
    { text: "¿Por qué siempre estoy rodeado de amor y apoyo?" },
    { text: "¿Por qué mis relaciones están llenas de confianza y felicidad?" },
  ],
} as const;
